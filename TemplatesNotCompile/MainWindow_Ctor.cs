...
public partial class MainWindow_Ctor : Window, IEssentialMainWindow, IHideToTray, IConfigurableWindow, IMainWindowBasicControls
{
    ...
    public void MainWindow_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        string appName = "";
        // FirstSection ji� bohu�el nem�m
        //MainWindow_Ctor.FirstSection<Dispatcher>(appName, WpfApp.Init, ClipboardHelperWinStd.Instance, CheckIsAlreadyRunning, null, Dispatcher);
        ...
        catch (Exception ex)
        {
            ...
            {
                // Probably was not sent ThisApp.EventLogName
            }
        }
        ...
        miGenerateScreenshot.Header = Translate.FromKey(XlfKeys.GenerateScreenshot);
