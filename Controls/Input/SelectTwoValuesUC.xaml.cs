...
/// </summary>
public partial class SelectTwoValues : UserControl, IUserControl, IControlWithResultWpf
{
    ...
    public string Title => Translate.FromKey(XlfKeys.SelectTwoValues);
    ...
    public void Init(string whatEnter1, IList values1, string whatEnter2, IList values2, string hint)
    {
