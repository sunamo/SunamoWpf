...
/// 
/// </summary>
public class SettingsManager : ISettingsManagerWpf<FrameworkElement, DependencyProperty>
{
    ...
    public void AddFromSavedElements(TUListWpf<FrameworkElement, DependencyProperty> list)
    {
    }
}