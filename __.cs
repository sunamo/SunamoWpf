...
public class __
{
    public static IMainWindowBasicControls mw = null;
    ...
    public static WindowWithUserControl windowWithUserControl { get => mw.windowWithUserControl; set => mw.windowWithUserControl = value; }
